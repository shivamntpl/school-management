...
@section('page-title')
<i class="fas fa-bus-alt"></i>Add Vehicle
@endsection
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('vehicle.store') }}" enctype="multipart/form-data">
                ...
                <div class="d-flex gap-3 mb-3 flex-wrap">
                    <div class="flex-fill">
                        ...
                        <input type="text" class="form-control" id="driver_phone" name="driver_phone"
                            value="{{ old('driver_phone') }}" min="1" max="100">
                ...
                <div class="d-flex gap-3 mb-3 flex-wrap">
                    ...
                    <div class="flex-fill">
                        <label for="monthly_charge" class="form-label">Monthly Charge<span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="monthly_charge" name="monthly_charge"
                            value="{{ old('monthly_charge') }}">
